...
namespace Repository.Migrations
{
    ...
    [Migration("20240820071500_AddedDiscountPriceColumbBasketItemTable")]
    partial class AddedDiscountPriceColumbBasketItemTable
    {
            ...
            modelBuilder.Entity("Domain.Entities.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(1029),
                            Discount = 20.0,
            ...
            modelBuilder.Entity("Domain.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(921),
                            Key = "Address",
                            Value = "28 May"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(923),
                            Key = "Phone",
                            Value = "+9945556622"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(924),
                            Key = "Email",
            ...
            modelBuilder.Entity("Domain.Entities.SocialMedia", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(934),
                            Platform = "Linkedin",
                            Url = "linkedin.com"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(936),
                            Platform = "Instagram",
                            Url = "instagram.com"
                        },
                        new
            ...
            modelBuilder.Entity("Domain.Entities.VariantType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(822),
                            Name = "Size choice"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(823),
                            Name = "Sauce choice"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(824),
                            Name = "Drink choice"
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(825),
                            Name = "Crust choice"
                        },
                        new
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2024, 8, 20, 11, 15, 0, 203, DateTimeKind.Local).AddTicks(826),
